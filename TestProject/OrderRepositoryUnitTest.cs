...
namespace TestProject
{
    public class OrderRepositoryUnitTest
    {
        ...
        {
            // Arrange
            var order1 = new Order { OrderId = 1, UserId = 1, OrderDate = DateOnly.FromDateTime(DateTime.Now), OrderSum = 100.0 };
            var order2 = new Order { OrderId = 2, UserId = 2, OrderDate = DateOnly.FromDateTime(DateTime.Now), OrderSum = 200.0 };
        ...
        {
            // Arrange
            var order = new Order { OrderId = 1, UserId = 1, OrderDate = DateOnly.FromDateTime(DateTime.Now), OrderSum = 150.0 };
