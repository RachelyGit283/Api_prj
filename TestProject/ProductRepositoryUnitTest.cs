...
namespace TestProject
{
    public class ProductRepositoryUnitTest
    {
        ...
        {
            // Arrange
            var product1 = new Product { ProductId = 1, ProductName = "Product A", Description = "Description A", Price = 100, CategoryId = 1 };
            var product2 = new Product { ProductId = 2, ProductName = "Product B", Description = "Description B", Price = 200, CategoryId = 2 };
            var product3 = new Product { ProductId = 3, ProductName = "Product C", Description = "Description C", Price = 300, CategoryId = 1 };
